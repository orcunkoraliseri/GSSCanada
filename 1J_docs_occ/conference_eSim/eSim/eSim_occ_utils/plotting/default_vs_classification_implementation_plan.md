...
|--------|-----------------|------------------|
| **Default** | `0_BEM_Setup/Templates/schedule.json` (parsed via `eSim_bem_utils.idf_optimizer`)<br>Profile: `ApartmentMidRise OCC_APT_SCH` | Same JSON<br>Profile: `ApartmentMidRise Activity Schedule` (95W) |
| **2025 GSS** | `0_BEM_Setup/BEM_Schedules_2025.csv` | `0_BEM_Setup/BEM_Schedules_2025.csv` |
...
#### [NEW] [plot_default_vs_classification.py](file:///Users/orcunkoraliseri/Desktop/Postdoc/eSim/eSim_occ_utils/plotting/plot_default_vs_classification.py)

- **Imports**: `eSim_bem_utils.idf_optimizer` to load standard schedules reliably.
- **Process**:
...
- **Output**: `eSim_occ_utils/plotting/Fig_4_1_3_Default_vs_Classification.png`.

---

## Verification Plan

1. Run: `python3 eSim_occ_utils/plotting/plot_default_vs_classification.py`
2. Confirm:
