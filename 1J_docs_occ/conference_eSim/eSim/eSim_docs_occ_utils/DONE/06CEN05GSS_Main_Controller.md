...
### Interactive Menu
```bash
python eSim_occ_utils/06CEN05GSS_main.py
```

### With Custom Sample
```bash
python eSim_occ_utils/06CEN05GSS_main.py --sample 10
```

### Run Specific Step Directly
```bash
python eSim_occ_utils/06CEN05GSS_main.py --run 5  # Full pipeline
```
...
`eSim_occ_utils/06CEN05GSS_main.py`
