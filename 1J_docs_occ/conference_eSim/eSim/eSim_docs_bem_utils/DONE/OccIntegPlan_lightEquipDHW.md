...
*   **Source**: We replace existing schedules in the `.idf` with standardized "ApartmentMidrise" versions (/Users/orcunkoraliseri/Desktop/Postdoc/eSim/0_BEM_Setup/Templates/schedule.json).
...
*   **Module**: `eSim_bem_utils/schedule_generator.py`
...
*   **Integration**: `eSim_bem_utils/integration.py`
