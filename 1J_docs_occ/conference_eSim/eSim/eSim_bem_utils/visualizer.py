...
def visualize_idf(idf_path: str) -> None:
    ...
    try:
        ...
        for surf in surfaces:
            ...
            bc = surf.Outside_Boundary_Condition.lower() if surf.Outside_Boundary_Condition else ''
            ...
            poly = Poly3DCollection([abs_coords], alpha=0.9, 
            ...
            for sub in subsurfs:
                if sub.Building_Surface_Name == surf.Name:
                    ...
                    sub_poly = Poly3DCollection([sub_abs_coords], alpha=0.7, 
                                                facecolors='lightblue', edgecolors='darkblue')
                    ax.add_collection3d(sub_poly)
                    counts['window'] += 1
        
        print(f"Drawn: {counts['wall']} walls, {counts['roof']} roofs, "
