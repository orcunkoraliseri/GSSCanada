...
def train(args):
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        # Gate best-model saving and patience on being past warmup.
        # During warmup the model makes near-uniform predictions that score
        # deceptively low on val_JS — saving epoch 1 as best locks out all
        # real training (F5/F6 trap).
