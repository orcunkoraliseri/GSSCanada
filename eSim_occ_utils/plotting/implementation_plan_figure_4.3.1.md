...
### Script Development
#### [NEW] [plot_figure_4.3.1.py](file:///C:/Users/o_iseri/Desktop/GSSCanada/GSSCanada-main/eSim_occ_utils/plotting/plot_figure_4.3.1.py)
...
- **Output**:
    - Saves image to `eSim_occ_utils\plotting\Figure_4.3.1_Energy_Demand.png`.
