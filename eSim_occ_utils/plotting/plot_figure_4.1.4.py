...
# Add project root to sys.path to allow imports from eSim_occ_utils
import sys
if str(BASE_DIR) not in sys.path:
    sys.path.append(str(BASE_DIR))

try:
    from eSim_occ_utils.occ_config import OUTPUT_DIR as GSS_OUTPUT_DIR
    GSS_FILE = GSS_OUTPUT_DIR / "BEM_Schedules_2025.csv"
except ImportError:
    # Fallback to direct path if config import fails
    GSS_FILE = BASE_DIR / "0_Occupancy" / "Outputs_CENSUS" / "BEM_Schedules_2025.csv"
