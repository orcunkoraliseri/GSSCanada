...
# Activity Files (HH_aggregation 25pct, or Full_data for 2025)
FILE_ACT_2005 = BASE_DIR / "0_Occupancy/Outputs_06CEN05GSS/HH_aggregation/06CEN05GSS_Full_Aggregated_sample25pct.csv"
FILE_ACT_2010 = BASE_DIR / "0_Occupancy/Outputs_11CEN10GSS/HH_aggregation/11CEN10GSS_Full_Aggregated_sample25pct.csv"
FILE_ACT_2015 = BASE_DIR / "0_Occupancy/Outputs_16CEN15GSS/HH_aggregation/16CEN15GSS_Full_Aggregated_sample25pct.csv"
FILE_ACT_2022 = BASE_DIR / "0_Occupancy/Outputs_21CEN22GSS/HH_aggregation/21CEN22GSS_Full_Aggregated_sample25pct.csv"
FILE_ACT_2025 = BASE_DIR / "0_Occupancy/Outputs_CENSUS/Full_data.csv"

# BEM Metabolic Schedule Files (occToBEM 25pct, or BEM_Schedules_2025 for 2025)
...
def main():
    print("="*60)
    print("  ACTIVITY & METABOLIC COMPARISON PLOT GENERATOR (2x5 GRID)")
    print("="*60)
    ...
    files_act = [FILE_ACT_2005, FILE_ACT_2010, FILE_ACT_2015, FILE_ACT_2022, FILE_ACT_2025]
    ...
    metabolic_profiles = {}
    files_bem = [FILE_BEM_2005, FILE_BEM_2010, FILE_BEM_2015, FILE_BEM_2022, FILE_BEM_2025]
    ...
    fig, axes = plt.subplots(2, 5, figsize=(32, 12), constrained_layout=True)
    ...
    for i, year in enumerate(years):
        ...
        if year in df_act.index:
            ...
            ax.set_title(f"{year} - Activity Distribution", fontsize=13, fontweight='bold')
    ...
    for i, year in enumerate(years):
        ...
        if year in metabolic_profiles:
            ...
            ax.set_title(f"{year} - Metabolic Profile", fontsize=13, fontweight='bold')
            ...
            if i == 0:
                ...
                ax.text(1, 102, "95W Default (DOE Prototype)", color='darkred', fontsize=10, fontweight='bold')
