# -*- coding: utf-8 -*-
"""Figure 2 - the leave-one-country-out design and the three nulls.

TIER C2 REPAIR, 2026-09-14. Retitled from "two nulls" to "three nulls" to match
the manuscript caption (4J_manuscript_submission.md:102) and the body's "three
registered nulls" language (line 650). The schematic itself is unchanged: it
still draws the one primary null (the raked donor pool) that the LOCO transfer
test is scored against; the two secondary nulls (single-donor-country and the
discrimination check, 4J_manuscript_submission.md:374-378) are prose-only and
are not depicted here, matching this figure's own "What must NOT appear" scope.
