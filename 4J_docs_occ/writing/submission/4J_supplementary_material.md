...
conventions. S11 limitations in full. S12 open items and documentation notes.
...
| Observed stock, earlier layout | earlier subdivision layout, method record | 410 cells |
...
**Earlier observed-stock layout (410 cells).** On this method record, moving from no occupancy signal to the
...
Madrid, 840 cells in 84 buildings did not complete and were not repaired. Three courtyard buildings in
...
**Earlier layout (410 cells).** An earlier campaign of 410 cells, with a different subdivision layout, is
kept as a method and reproducibility record (S7.6). Two of its provenance links are missing: five manifest
...
it is used (S9). In Madrid, 840 cells in 84 buildings did not complete, and three courtyard buildings in
