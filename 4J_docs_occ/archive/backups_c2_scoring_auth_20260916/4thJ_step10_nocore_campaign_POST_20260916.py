...
AUTHORISED = {
    ...
    "IT-BOL-GALVANI2": {
        ...
        "sentence": (
            ...
            'done you can go until the end thank you || Score the finished '
            'C2 cells for Madrid, London and Bologna as G10N.x results.'),
        "date": '2026-09-16',
    },
    # ---------------------------------------------------------------- 2 ----
    ...
    "ES-MAD-BERRUGUETE": {
        ...
        "sentence": (
            ...
            'can go until the end thank you || Score the finished C2 cells '
            'for Madrid, London and Bologna as G10N.x results.'),
        "date": '2026-09-16',
    },
    "GB-LDN-STDUNSTANS": {
        "mode": 'campaign',
