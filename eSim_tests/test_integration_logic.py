...
class TestIntegrationLogic(unittest.TestCase):
    ...
    def test_baseload_logic_single_home(self):
        ...
        with patch('eSim_bem_utils.integration.parse_schedule_values') as mock_parse:
            ...
            with patch('eSim_bem_utils.integration.idf_optimizer'), patch.object(integration, 'IDF'):
                 ...
                 with patch('eSim_bem_utils.integration.IDF', return_value=mock_idf):
