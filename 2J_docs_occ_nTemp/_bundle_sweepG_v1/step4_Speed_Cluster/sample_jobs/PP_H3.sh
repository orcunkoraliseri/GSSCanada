#!/encs/bin/bash
#SBATCH --job-name=PP_H3
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/PP_H3_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/PP_H3_%j.err

# Cycle rebalancing (2022 oversampled 2x) + F8 mask bounds.
set -e
...
export CYCLE_OVERSAMPLE_2022=2.0
...
echo "=== ${TAG} TRAIN START (cycle_oversample_2022=2.0 + F8 mask) ==="
