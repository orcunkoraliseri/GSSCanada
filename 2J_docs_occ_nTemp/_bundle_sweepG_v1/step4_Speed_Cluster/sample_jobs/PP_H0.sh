#!/encs/bin/bash
#SBATCH --job-name=PP_H0
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/PP_H0_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/PP_H0_%j.err

# Stage H control: F8 mask bounds on 10% sample (fresh run for fair comparison).
set -e
