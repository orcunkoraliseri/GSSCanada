#!/encs/bin/bash
#SBATCH --job-name=J3_smoke
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=02:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/J3_smoke_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/J3_smoke_%j.err

# J3 smoke run — 10 epochs, --sample (small model, fast).
# Pass criterion: home_loss materially below J1's 0.36 floor by ep 5-10.
# Architecture: arm2_act_proj Linear(14, d_model) before Arm-2 concat.
...
CONFIG_PATH="$BASE/configs/sweep_smoke_J3.yaml"
TRIAL_TAG=J3_smoke
...
echo "============================================================"
echo "J3 smoke run: MODEL_TYPE=${MODEL_TYPE}  DATA_DIR=$DATA_DIR"
