#!/encs/bin/bash
#SBATCH --job-name=MDLM_C
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_C_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_C_%j.err

# Phase 6 Stage C Trial 1: Masked Discrete Diffusion promoted from Stage B (#1, composite=0.6898).
# Full data (outputs_step4_G2, ~150k respondents), 100 epoch cap, patience 15.
# Train -> infer -> 04H -> 04I -> 04J. Output: outputs_step4_full/MDLM_C/
