#!/encs/bin/bash
#SBATCH --job-name=MDLM_F5
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F5_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F5_%j.err

# Stage F Trial 5: x0_refiner_layers=4 (default 2).
...
echo "=== ${TAG} TRAIN START (MDLM_REFINER_LAYERS=4) ==="
