#!/encs/bin/bash
#SBATCH --job-name=MDLM_F7
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F7_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F7_%j.err

# Stage F Trial 7: mask_clamp=[0.15, 0.85] tighter (default 0.05-0.95).
...
export MDLM_MASK_LO=0.15
export MDLM_MASK_HI=0.85
...
echo "=== ${TAG} TRAIN START (MDLM_MASK_LO=0.15, HI=0.85) ==="
