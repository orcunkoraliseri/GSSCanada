#!/encs/bin/bash
#SBATCH --job-name=MDLM_F6
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F6_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F6_%j.err

# Stage F Trial 6: x0_refiner=4 + n_enc_layers=8 (default 2+6).
...
echo "=== ${TAG} TRAIN START (MDLM_REFINER_LAYERS=4, n_enc=8) ==="
