...
::: {custom-style="Caption"}
**Figure 1.** End-to-end occupancy-to-energy pipeline (Steps 1–9).
:::
...
::: {custom-style="Caption"}
**Figure 3.** Conditional generator (calibrated J3) architecture.
:::
...
::: {custom-style="Caption"}
**Figure 5.** Occupancy driver: diurnal at-home shift.
:::
...
::: {custom-style="Caption"}
**Figure 6.** Diurnal load-shape reshaping under work-from-home.
:::
...
::: {custom-style="Caption"}
**Figure 7.** Activity-driven equipment: magnitude correction and intraday shape.
:::
...
::: {custom-style="Caption"}
**Figure S5.** Equipment annual calibration against SHEU.
:::

![Figure S6](figures/SI/Figure_S06_sheu_pct.png)

::: {custom-style="Caption"}
**Figure S6.** Percent deviation from SHEU, all 48 cell-years (the calibration gate).
:::

![Figure S7](figures/SI/Figure_S07_peak_shift_null.png)

::: {custom-style="Caption"}
**Figure S7.** Equipment baseline→activity peak-hour shift, all cells (null result).
:::

![Figure S8](figures/SI/Figure_S08_longitudinal.png)

::: {custom-style="Caption"}
**Figure S8.** Longitudinal load-shape trajectory.
:::

![Figure S9](figures/SI/Figure_S09_eui.png)

::: {custom-style="Caption"}
**Figure S9.** Annual energy use intensity by archetype and city.
:::
