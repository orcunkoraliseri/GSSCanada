...
*Source:* `methodology_assessment_and_paper_skeleton.md` Part 3b (Steps 1–3); weighted AT_HOME % from `00_GSS_Occupancy_Pipeline.md` §Step 3D merged-dataset statistics (computed by `03_mergingGSS_val.py`; survey-weighted respondent-level rate after the diary-closure filter — NOT the Step-2 unfiltered episode rate of 63.5/63.5/66.1/72.3 %); `02_harmonizationGSS_val.md` TUI_10_AVAIL flags
