#!/encs/bin/bash
#SBATCH --job-name=SEDD_B
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/SEDD_B_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/SEDD_B_%j.err

# Phase 6 Stage B Trial 3: Score-Entropy Discrete Diffusion promoted from Stage A (#2, composite=1.034).
# 20% stratified sample (~30k respondents), 100 epoch cap, patience 15.
# Train -> infer -> 04H -> 04I -> 04J. Output: outputs_step4_sample/SEDD_B/
