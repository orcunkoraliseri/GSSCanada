#!/encs/bin/bash
#SBATCH --job-name=MDLM_D3
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_D3_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_D3_%j.err

# Phase 6 Stage D Trial 3: per-cell marginal bias.
# lambda_home 0.7->0.9, home_label_smooth 0.05->0.02, marg_mode global->per_cs.
