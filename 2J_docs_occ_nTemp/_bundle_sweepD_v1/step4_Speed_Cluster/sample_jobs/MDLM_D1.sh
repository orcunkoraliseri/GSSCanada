#!/encs/bin/bash
#SBATCH --job-name=MDLM_D1
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_D1_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_D1_%j.err

# Phase 6 Stage D Trial 1: conservative AT_HOME push.
# lambda_home 0.7->0.9, home_label_smooth 0.05->0.02.
