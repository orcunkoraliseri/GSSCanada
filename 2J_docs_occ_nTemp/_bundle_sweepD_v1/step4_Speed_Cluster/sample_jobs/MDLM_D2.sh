#!/encs/bin/bash
#SBATCH --job-name=MDLM_D2
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_D2_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_D2_%j.err

# Phase 6 Stage D Trial 2: aggressive AT_HOME push.
# lambda_home 0.7->1.0, home_label_smooth 0.05->0.0.
