#!/encs/bin/bash
#SBATCH --job-name=MDLM_D5
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_D5_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_D5_%j.err

# Phase 6 Stage D Trial 5: full-push combo.
# lambda_home->1.0, home_label_smooth->0.0, marg_mode->per_cs, lambda_marg->0.2.
