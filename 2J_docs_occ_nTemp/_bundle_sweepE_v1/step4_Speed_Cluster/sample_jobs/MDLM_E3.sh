#!/encs/bin/bash
#SBATCH --job-name=MDLM_E3
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_E3_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_E3_%j.err

# Phase 6 Stage E Trial 3: E1 + demographic amplification (aux_stratum_head + data_side_sampling).
