#!/encs/bin/bash
#SBATCH --job-name=MDLM_D4
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_D4_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_D4_%j.err

# Phase 6 Stage D Trial 4: slower LR for finer convergence.
# lambda_home 0.7->0.9, home_label_smooth 0.05->0.02, lr 5e-5->3e-5.
