#!/encs/bin/bash
#SBATCH --job-name=MDLM_D6
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_D6_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_D6_%j.err

# Phase 6 Stage D Trial 6: AT_HOME push + transition penalty for act_JS.
# lambda_home 0.7->0.9, home_label_smooth 0.05->0.02, lambda_trans 0.0->0.05.
