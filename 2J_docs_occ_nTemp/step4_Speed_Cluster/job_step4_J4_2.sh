#!/encs/bin/bash
#SBATCH --job-name=J4_2
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=24:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/J4_2_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/J4_2_%j.err

# J4_2 full training run — hierarchical cop conditioning (home → cop), lambda_home=0.7.
# Submit only after smoke pass.
# Single axis vs J3: enable_hierarchical_cop=True only; no temporal injection, no logic loss.
...
CONFIG_PATH="$BASE/configs/J4_2.yaml"
TRIAL_TAG=J4_2
...
echo "============================================================"
echo "J4_2 full run: MODEL_TYPE=${MODEL_TYPE}  DATA_DIR=$DATA_DIR"
