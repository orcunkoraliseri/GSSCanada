#!/encs/bin/bash
#SBATCH --job-name=MDLM_E4
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_E4_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_E4_%j.err

# Phase 6 Stage E Trial 4: E1 + deeper FiLM (04B_model_MDLM_v2.py).
# MODEL_TYPE=MDLM_v2 uses 2-layer MLP FiLM (d_cond->128->d_model) for demographic amplification.
