#!/encs/bin/bash
#SBATCH --job-name=GCE_A
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/GCE_A_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/GCE_A_%j.err

# Phase 6 Stage A Trial 9: J3 backbone + Generalized Cross-Entropy (q=0.5, no CC).
# 2% stratified sample (~3k respondents), 50 epoch cap, ~1h wall-clock on pg.
# Train -> infer -> 04H -> 04I -> 04J. Output: outputs_step4_sample/GCE_A/
