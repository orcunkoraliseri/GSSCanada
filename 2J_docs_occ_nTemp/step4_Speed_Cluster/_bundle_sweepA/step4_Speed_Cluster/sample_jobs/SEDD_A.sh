#!/encs/bin/bash
#SBATCH --job-name=SEDD_A
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/SEDD_A_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/SEDD_A_%j.err

# Phase 6 Stage A Trial 10: Score-Entropy Discrete Diffusion + CC.
# 2% stratified sample (~3k respondents), 50 epoch cap, ~1h wall-clock on pg.
# Train -> infer -> 04H -> 04I -> 04J. Output: outputs_step4_sample/SEDD_A/
