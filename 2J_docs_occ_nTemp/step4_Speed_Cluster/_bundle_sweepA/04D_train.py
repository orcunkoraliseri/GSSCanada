...
def train(args):
    ...
    elif MODEL_TYPE in ("HSMM", "MDLM", "HIER", "MAMBA", "SEDD"):
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        for batch in train_loader:
            ...
            _clip_norm = 25.0 if MODEL_TYPE in ("I1", "J1", "J2", "J2_5", "J3", "J3_v2", "J3_v3", "J4_1", "J4_2", "J4_3", "J5_X1", "J5_X1b", "J5_A", "J5_B", "J5_F", "J_old", "J5_C", "HSMM", "MDLM", "HIER", "MAMBA", "SEDD") else 1.0
