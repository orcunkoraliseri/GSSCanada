#!/encs/bin/bash
#SBATCH --job-name=PP_H4
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/PP_H4_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/PP_H4_%j.err

# Entity embedding + ORIGINAL mask bounds (test architecture interaction).
set -e
...
echo "=== ${TAG} TRAIN START (entity_embed=1 + original mask) ==="
