#!/encs/bin/bash
#SBATCH --job-name=SEDD_C
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/SEDD_C_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/SEDD_C_%j.err

# Phase 6 Stage C Trial 2: Score-Entropy Discrete Diffusion promoted from Stage B (#2, composite=0.8666).
# Hedge against MDLM_C: SEDD had AT_HOME parity with MDLM at 20%; may scale differently at full data.
# Full data (outputs_step4_G2, ~150k respondents), 100 epoch cap, patience 15.
# Train -> infer -> 04H -> 04I -> 04J. Output: outputs_step4_full/SEDD_C/
