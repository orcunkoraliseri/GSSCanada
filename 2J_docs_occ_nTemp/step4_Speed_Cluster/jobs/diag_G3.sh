#!/encs/bin/bash
#SBATCH --job-name=diag_G3
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/diag_G3_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/diag_G3_%j.err
...
# Symlink data files needed by diagnostics into model output dir
...
# Stage 2: AT_HOME diagnostics (CPU)
echo ""
...
# Stage 3: Activity + copresence diagnostics (CPU)
echo ""
...
# Stage 4: Statistical diagnostics + composite (CPU)
echo ""
