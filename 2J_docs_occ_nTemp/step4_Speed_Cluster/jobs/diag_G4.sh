#!/encs/bin/bash
#SBATCH --job-name=diag_G4
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/diag_G4_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/diag_G4_%j.err
