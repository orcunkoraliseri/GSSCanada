#!/encs/bin/bash
#SBATCH --job-name=J1_smoke
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=02:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/J1_smoke_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/J1_smoke_%j.err

# J1 smoke run — 10 epochs, --sample (small model, fast).
...
CONFIG_PATH="$BASE/configs/sweep_smoke_J1.yaml"
TRIAL_TAG=J1_smoke
...
echo "============================================================"
echo "J1 smoke run: MODEL_TYPE=${MODEL_TYPE}  DATA_DIR=$DATA_DIR"
