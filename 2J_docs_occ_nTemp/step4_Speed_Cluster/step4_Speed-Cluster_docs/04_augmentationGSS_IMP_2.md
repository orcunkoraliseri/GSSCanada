...
- `comparision.md` — full architecture comparison (Tables 1–3, training losses + inference gate results)
...
All training logs archived to `CSV_records/`. Full comparison table at `comparision.md`.
...
**Updated documents:**
- `comparision.md` — Table 3 updated with G3/G4 results
