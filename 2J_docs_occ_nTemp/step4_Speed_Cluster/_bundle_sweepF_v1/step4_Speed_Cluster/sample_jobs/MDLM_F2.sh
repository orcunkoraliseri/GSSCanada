#!/encs/bin/bash
#SBATCH --job-name=MDLM_F2
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F2_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F2_%j.err

# Stage F Trial 2: denoise_steps=64 (default 16).
...
echo "=== ${TAG} TRAIN START (MDLM_STEPS=64) ==="
