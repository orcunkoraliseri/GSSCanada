#!/encs/bin/bash
#SBATCH --job-name=MDLM_F0
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F0_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F0_%j.err

# Stage F Trial 0: CONTROL — MDLM_C defaults on 10% sample.
