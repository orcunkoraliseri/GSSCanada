#!/encs/bin/bash
#SBATCH --job-name=MDLM_F4
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F4_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F4_%j.err

# Stage F Trial 4: mask_schedule=linear, clamp 0.1-0.9.
...
export MDLM_MASK_SCHEDULE=linear
export MDLM_MASK_LO=0.1
export MDLM_MASK_HI=0.9
...
echo "=== ${TAG} TRAIN START (MDLM_MASK_SCHEDULE=linear, LO=0.1, HI=0.9) ==="
