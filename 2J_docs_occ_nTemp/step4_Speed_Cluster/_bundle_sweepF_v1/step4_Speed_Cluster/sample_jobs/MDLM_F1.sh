#!/encs/bin/bash
#SBATCH --job-name=MDLM_F1
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/MDLM_F1_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/MDLM_F1_%j.err

# Stage F Trial 1: denoise_steps=32 (default 16).
...
echo "=== ${TAG} TRAIN START (MDLM_STEPS=32) ==="
