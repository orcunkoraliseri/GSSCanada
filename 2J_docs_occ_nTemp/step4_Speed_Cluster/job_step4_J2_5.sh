#!/encs/bin/bash
#SBATCH --job-name=J2_5
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=24:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/J2_5_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/J2_5_%j.err

# J2.5 full training run — home_head GELU+Dropout variant, lambda_home=0.7.
# Submit only after smoke pass.
# No --fp16: disabled at dispatch level for MODEL_TYPE=J2_5.
...
CONFIG_PATH="$BASE/configs/J2_5.yaml"
TRIAL_TAG=J2_5
...
echo "============================================================"
echo "J2.5 full run: MODEL_TYPE=${MODEL_TYPE}  DATA_DIR=$DATA_DIR"
