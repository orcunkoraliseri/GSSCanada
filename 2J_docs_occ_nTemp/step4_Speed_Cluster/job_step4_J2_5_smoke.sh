#!/encs/bin/bash
#SBATCH --job-name=J2_5_smoke
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=02:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/J2_5_smoke_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/J2_5_smoke_%j.err

# J2.5 smoke run — 10 epochs, --sample (small model, fast).
# Pass criterion: home_loss materially below J1's 0.36 floor by ep 5-10.
# Architecture: home_head = Linear->GELU->Dropout->Linear (drops Tanh collapse).
...
CONFIG_PATH="$BASE/configs/sweep_smoke_J2_5.yaml"
TRIAL_TAG=J2_5_smoke
...
echo "============================================================"
echo "J2.5 smoke run: MODEL_TYPE=${MODEL_TYPE}  DATA_DIR=$DATA_DIR"
