#!/encs/bin/bash
#SBATCH --job-name=CC_SPL_A
#SBATCH --partition=pg
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=48:00:00
#SBATCH --output=/speed-scratch/o_iseri/occModeling/logs/CC_SPL_A_%j.out
#SBATCH --error=/speed-scratch/o_iseri/occModeling/logs/CC_SPL_A_%j.err

# Phase 6 Stage A Trial 2: CC + Semantic Probabilistic Layer (soft logic constraints).
# 2% stratified sample (~3k respondents), 50 epoch cap, ~1h wall-clock on pg.
# Train -> infer -> 04H -> 04I -> 04J. Output: outputs_step4_sample/CC_SPL_A/
