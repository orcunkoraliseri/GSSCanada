...
def check_raw_hours():
    try:
        df05 = pd.read_csv("outputs/main_2005.csv", usecols=['WKWEHR_C'])
        print("=== 2005 WKWEHR_C ===")
    ...
    try:
        df10 = pd.read_csv("outputs/main_2010.csv", usecols=['WKWEHR_C'])
        print("\n=== 2010 WKWEHR_C ===")
    ...
    try:
        df15 = pd.read_csv("outputs/main_2015.csv", usecols=['WHWD140C'])
        print("\n=== 2015 WHWD140C ===")
    ...
    try:
        df22 = pd.read_csv("outputs/main_2022.csv", usecols=['WHWD140G'])
        print("\n=== 2022 WHWD140G ===")
