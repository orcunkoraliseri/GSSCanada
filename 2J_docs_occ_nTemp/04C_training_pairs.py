...
def main():
    ...
    train_meta = load_metadata(out_dir, "train")
    val_meta   = load_metadata(out_dir, "val")
    ...
    # Save
    train_path = os.path.join(out_dir, "training_pairs.pt")
    val_path   = os.path.join(out_dir, "val_pairs.pt")
