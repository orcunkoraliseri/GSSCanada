...
3. **Output**:
    - Save to `occ_utils\plotting\Table_4.3.4_Peak_Loads.csv`.
...
### Script Development
#### [NEW] [plot_figure_4.3.4.py](file:///C:/Users/o_iseri/Desktop/GSSCanada/GSSCanada-main/occ_utils/plotting/plot_figure_4.3.4.py)
- **Functions**:
