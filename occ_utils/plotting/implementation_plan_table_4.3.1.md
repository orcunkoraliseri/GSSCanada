...
### Script Development
#### [NEW] [generate_table_4.3.1.py](file:///C:/Users/o_iseri/Desktop/GSSCanada/GSSCanada-main/occ_utils/plotting/generate_table_4.3.1.py)
...
- **Output**:
    - Saves the table as a CSV file to `C:\Users\o_iseri\Desktop\GSSCanada\GSSCanada-main\occ_utils\plotting\Table_4.3.1_Annual_Energy_Demand.csv`.
