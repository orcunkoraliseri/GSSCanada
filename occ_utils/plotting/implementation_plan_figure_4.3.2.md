...
### Script Development
#### [NEW] [plot_figure_4.3.2.py](file:///C:/Users/o_iseri/Desktop/GSSCanada/GSSCanada-main/occ_utils/plotting/plot_figure_4.3.2.py)
...
- **Logic**:
    ...
    3. Loop Cities:
        ...
        - Annotate gaps.
- **Output**:
    - Saves image to `occ_utils\plotting\Figure_4.3.2_Temporal_Trend.png`.
