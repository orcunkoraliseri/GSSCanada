...
| Series | Source |
|--------|--------|
| **Default** | `BEM_Setup/Templates/schedule.json` via `bem_utils.idf_optimizer` |
| **2025 GSS** | `BEM_Setup/BEM_Schedules_2025.csv` (Weekday + Weekend) |
...
#### [NEW] [generate_schedule_discrepancy_table.py](file:///Users/orcunkoraliseri/Desktop/Postdoc/eSim/occ_utils/plotting/generate_schedule_discrepancy_table.py)

- Load Default schedules from JSON (via `bem_utils.idf_optimizer`)
...
1. Run: `python3 occ_utils/plotting/generate_schedule_discrepancy_table.py`
