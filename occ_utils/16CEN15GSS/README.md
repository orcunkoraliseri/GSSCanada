...
Occupancy modeling pipeline for **Census 2016 + GSS 2015** integration.

## Structure

This folder will contain modules for:
...
`Occupancy/Outputs_16CEN15GSS/`

## Status

🚧 **Under Development** - Modules to be created step by step
