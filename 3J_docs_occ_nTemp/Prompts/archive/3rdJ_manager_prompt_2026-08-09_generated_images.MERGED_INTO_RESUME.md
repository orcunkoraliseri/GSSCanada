# 3J manager prompt - THE standing handoff, last updated 2026-08-09 (generated-images round)
...
> `archive/3rdJ_manager_prompt_2026-08-09_ledger.SUPERSEDED_by_generated_images_round.md`,
> `archive/3rdJ_manager_prompt_2026-08-09_round2.SUPERSEDED_by_full_ledger_round.md`,
> `archive/3rdJ_manager_prompt_2026-08-09.SUPERSEDED_by_docx_cleanup_round.md`,
...
4. [Everything completed, round by round](#everything-completed-round-by-round)
5. [Open BUILD NOTE 1 of 3: Table A2 ships unlabelled and uncited](#open-build-note-1-of-3-table-a2-ships-unlabelled-and-uncited)
6. [Open BUILD NOTE 2 of 3: two references have never been opened](#open-build-note-2-of-3-two-references-have-never-been-opened)
7. [Open BUILD NOTE 3 of 3: the generated-image defects](#open-build-note-3-of-3-the-generated-image-defects)
8. [What is settled, so nobody reopens it](#what-is-settled-so-nobody-reopens-it)
9. [The work that is left, in the order I would do it](#the-work-that-is-left-in-the-order-i-would-do-it)
10. [Refusals still standing](#-refusals-still-standing-the-first-one-costs-money-if-it-is-forgotten)
11. [Standing hazards](#standing-hazards-and-every-one-of-them-has-already-bitten-this-project)
12. [Hard rules for this phase](#hard-rules-for-this-phase)
13. [The closure ritual, every round, unprompted](#the-closure-ritual-every-round-unprompted)
...
overridden that five times now and will probably again; when they do, do the work and log it.
...
**The paper is written, built, rendered and gate-clean. It is not submitted, and two notes block it.**
...
| figures 1-6, S1, S2, S3, abstract | **author-generated, 1376 x 768 px, no vector PDF** |
| figures 7-11 | **untouched** - 600 dpi with vector PDF. They are the measured results |
...
writing/submission/
  ...
  3J_manuscript_submission.docx   <- 15.1 MB, 22 captions, 15 images, 14 tables, SINGLE spaced
  figures/  figures/SI/           <- 12 PNG + 11 vector PDF, plus the 3 SI figures
  figures/Prompts_Images/         <- the 9 image-generation prompts + README (2026-08-09)
  tables/   tables/SI/
...
vanished from the shipped file. **No blinded build is needed**: review is single-anonymized (RV10
item 14).

**The build tells you whether the paper is ready:**

```
!! 2 open. readySubmission.md is CLEAN but NOT READY.
```
...
below. This table exists so a fresh session knows what is **done and closed** without reading 1,673
...
| #3 | The handoff rebuilt as a full ledger with a twelve-entry table of contents | a dash check reported **281 matches on a file containing zero**, and exited 0 |
...
**Image prompts at `submission/figures/Prompts_Images/`** - the 8 schematic prompts, a new
graphical-abstract prompt, and a README that separates the **9 prompt-able schematics** from the **6
figures carrying measured numbers that must not be prompted** (Figures 7-11 and S1), lists the three
rules any generated image must satisfy, and names what the swap would cost: `f5` C2's md5 re-run stops
being able to fail, the vector PDF goes, and `f3` needs its hash updated.
...
- **The assistant NEVER creates images.** Author instruction 2026-08-09, now a hard-rule section in
  ...
  deliverable, with file, column and source line named. All fifteen manuscript images now have a
  prompt at `writing/submission/figures/Prompts_Images/`.
