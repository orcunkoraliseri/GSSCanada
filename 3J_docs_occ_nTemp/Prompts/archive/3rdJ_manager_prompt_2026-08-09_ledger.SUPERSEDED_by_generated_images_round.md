# 3J manager prompt - THE standing handoff, last updated 2026-08-09 (full-ledger round)
...
5. [Open BUILD NOTE 1 of 2: Table A2 ships unlabelled and uncited](#open-build-note-1-of-2-table-a2-ships-unlabelled-and-uncited)
6. [Open BUILD NOTE 2 of 2: two references have never been opened](#open-build-note-2-of-2-two-references-have-never-been-opened)
...
| | |
|---|---|
| `readySubmission.md` | **1,325 lines**, 22 captions (1,467 before the docx cleanup round) |
...
| `f5` figures | 7 PASS / 0 FAIL |
| `f6` replot equivalence | 5 PASS / 0 FAIL |
| figures | every one 300 or 600 dpi with a vector PDF |
| open BUILD NOTES | **2** - Table A2, and Kurin/Menon |
