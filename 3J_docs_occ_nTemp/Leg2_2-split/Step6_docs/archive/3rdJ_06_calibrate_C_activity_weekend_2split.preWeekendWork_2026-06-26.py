...
Post-hoc correction of two Step-6 drifts in the 2030 deliverable:
...
Stage 1 -- weekend home restore (hom30, DDAY_STRATA in {2,3} only):
  ...
  Weekday (DDAY_STRATA=1) hom30 left untouched. wrk30 untouched throughout.
...
def main() -> None:
    ...
    print("  wrk30 untouched; weekday hom30 untouched; Stage 1 touches weekend hom30 only.", flush=True)
