...
def load_standard_residential_schedules(
    ...
    Args:
        ...
        baseline: Which schedule set to load.
            'midrise'    â€” DOE MidRise Apartment (default; OpenStudio Standards
                           via 0_BEM_Setup/Templates/schedule.json).
            'sf_detached' â€” IECC 2021 Single-Family Detached reference
    ...
    for key, schedule_name in schedule_mapping.items():
        ...
        #   'Weekday' / 'Weekend' â€” Task 14 split (schedule_sf.json)
        #   'Default'             â€” single profile applied to both (schedule.json)
        # Two value formats:
    ...
    # Baseline is DOE MidRise from schedule.json â€” no overrides applied.
    if baseline == 'midrise':
