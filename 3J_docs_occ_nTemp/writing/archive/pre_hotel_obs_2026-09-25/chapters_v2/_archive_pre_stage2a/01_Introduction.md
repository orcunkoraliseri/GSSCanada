...
The authors' own prior work belongs to this first line. It built survey-grounded residential occupancy for Canada from successive General Social Survey cycles and carried it into building energy simulation (Iseri and Hachem-Vermette, in preparation a; Iseri and Hachem-Vermette, 2026). A related study carried the same residential line through the pandemic to 2030 scenarios and examined the daily load shape (Iseri and Hachem-Vermette, in preparation b). All of this work models one use.
