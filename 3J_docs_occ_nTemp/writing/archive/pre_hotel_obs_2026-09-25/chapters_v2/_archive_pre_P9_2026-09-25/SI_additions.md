...
| End-use loads | Two-channel checks against survey and prototype references | Four-channel checks, three reported outside their ranges (Table 4) | No | Different check sets and possibly a different basis; the two cannot be differenced |
