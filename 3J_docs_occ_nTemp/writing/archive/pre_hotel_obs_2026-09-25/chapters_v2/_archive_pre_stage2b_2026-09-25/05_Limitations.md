...
Each tower draws one set of households, and the Montreal and Calgary models share that set and the same office schedules. City differences therefore reflect climate and the retail and hotel inputs, not independent draws. Run-to-run sampling spread was not measured.

The code-schedule control puts residents and hotel guests on the NECB office schedule. Part of the presence contrast in Section 3.2 comes from that choice.

The retail median rule was adopted after an earlier run had been seen. It was fixed before the reported runs were read, and retail ⟦P10R:does not meet its range⟧ under the all-simulations rule as well.

The 2030 scenarios use typical-year weather, not a future climate.

The 2022 survey changed its collection mode, from telephone interviews to self-completed questionnaires, in the same cycle as the pandemic. Changes between 2015 and 2022, including the 2022 retail ⟦P10R:rise⟧, may partly reflect the mode change. Lower office and retail presence is associated with working from home and online shopping, but this study does not identify either as a cause.
