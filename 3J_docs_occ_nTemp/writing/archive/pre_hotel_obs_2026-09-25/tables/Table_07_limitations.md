...
| L5 | Reference ranges | The hotel reference range comes from a different building archetype and different cities. | Reference 284.44 and 299.28 kWh/m2/yr. Outside the range in 28 of 56 simulations, all in the Tall tower and all over the 300 ceiling; simulated values 204.83-322.18. |
...
| L7 | Reference ranges | Retail is validated on shape, not level; no time-of-day in-store reference exists. | Median 84.85 against a floor of 80, inside the range; 19 of 56 simulations under the floor. The retail rate check is reported for information only. |
