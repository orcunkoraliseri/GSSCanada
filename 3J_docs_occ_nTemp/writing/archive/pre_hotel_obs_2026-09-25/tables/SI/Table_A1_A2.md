...
| Selection rule | Discard checkpoints that do not pass the hard checks, then maximize retail F1 among the rest; no composite score. The delivered checkpoint deviates from this rule, as disclosed in §3.2 |
...
**Table A2.** - Retail presence codebook per GSS cycle.
