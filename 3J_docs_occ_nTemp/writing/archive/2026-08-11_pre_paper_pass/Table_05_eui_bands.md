...
| Residential | none defined | 113.9 / ⚠ check source / 147.2 kWh/m2/yr (SHEU HighRise) | 111.57-128.77 (median 119.10) | 101.54-115.05 (median 107.24) | n/a, INFO only | INFO, 55/56 outside the empirical band |
...
- Office. The as-modelled band floor is 100 kWh/m2/yr. All 56 injected campaign cells fail it
  ...
  floor, and it fails the band by 15 % before this work touches it. A gate that no untreated control
