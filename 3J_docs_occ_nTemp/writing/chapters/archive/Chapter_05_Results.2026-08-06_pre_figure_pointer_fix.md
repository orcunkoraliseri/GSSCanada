...
**Figure 8.** *(insert `Figure_08_diurnal_4ch.png` here)*

**Figure 9.** *(insert `Figure_09_peakhour_4ch.png` here)*

**Figure 10.** *(insert `Figure_10_longitudinal_4ch.png` here)*

**Figure 11.** *(insert `Figure_11_scenario_4ch.png` here)*
