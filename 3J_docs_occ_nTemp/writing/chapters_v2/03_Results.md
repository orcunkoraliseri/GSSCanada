...
**Figure 6.** *(insert `Figure_07_longitudinal_4ch.png` here)* Channel energy use intensity across the survey cycles. Hotel follows the code schedule until 2022.
...
**Figure 7.** *(insert `fig_codeschedule_vs_survey.png` here)* Code schedules against survey-based channels: (a) to (e) normalised weekday energy profiles by channel and for the whole building; (f) coincidence factor of each model.
