...
<!-- Graphical abstract and highlights are uploaded as separate files at submission (Elsevier order). The existing graphicalAbstract.png still shows the old lead (four peak hours); see rewrite_log.md open items. -->
