...
| L7 | Reference bands | Retail is validated on shape, not level; no time-of-day in-store reference exists. | Median 84.85 against a floor of 80, -6.07 % below, 19 of 56 cells under. The rate gate is informational. |
