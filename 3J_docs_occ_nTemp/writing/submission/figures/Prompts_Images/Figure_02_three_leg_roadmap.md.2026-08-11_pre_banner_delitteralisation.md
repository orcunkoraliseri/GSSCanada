...
The 2026-08-09 image labels its three containers **"Leg 1"**, **"Leg 2"**, **"Leg 3"**. Those are this
project's internal names for its own construction stages, they are not defined anywhere a reader can
reach, and the manuscript was rewritten on 2026-08-11 to remove them from every sentence. **The words
`Leg-1`, `Leg-2`, `Leg-3`, `Leg 1`, `Leg 2`, `Leg 3` must not appear anywhere in the image.**
...
| was drawn | draw instead |
|---|---|
| `Leg 1` | `Residential only` |
| `Leg 2` | `Residential + Office` |
| `Leg 3` | `Residential + Office + Retail + Hotel` with a second line `this paper` |
