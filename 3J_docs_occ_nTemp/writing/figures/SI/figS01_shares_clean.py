...
from fig_style import SLATE, TEAL, AMBER, GREY, INK, WHITE, LIGHT_GREY, new_fig, save_both, wrap_text
...
SERVICE_MEP = ("Service and plant space: 20.6 % of gross floor area (SuperTall), "
               "21.4 % (Tall); not occupiable")
