...
| **V2-F8** | Read BTAP (`github.com/CanmetENERGY/btap`) for NECB schedule definitions shipped as data | 30 min | V2-C4's `0.95` re-source, if it is in the repo at all | **OPEN** · the one new lead `RV06` produced; retrieval, not research |
