...
| **V2-C4** | The 0.95 retail peak — restate or re-source | 30 min | B-11, B-5 | **DONE** 08-04 (labelled; re-source owed) |
...
| **V2-F6** | Walk the `RV05` retrieval route ourselves: one prototype ZIP → `.table.htm` → Total Site Energy | 30 min | settles the vintage mismatch; falsifies or confirms `RV05` Section B | **OPEN** · prediction pre-registered 08-05 |
