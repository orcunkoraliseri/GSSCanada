...
*Updated 2026-08-05. **35 of 45 done · 0 in progress · 6 ready to start · 4 blocked.** Nothing is
waiting on the user any more: **all three WP-B decisions are taken**, and with **V2-D4 closed the
decisions are now in the code as well as in the docs** — the scorer, the master documents and the
decision record finally state the same bands.*
...
**🔄 IN PROGRESS — nothing right now.** V2-D4 closed 2026-08-05; pick the next item from READY below.

**⬜ READY TO START — unblocked, in the order I would do them**

| # | ID | Why it is next |
|---|---|---|
| 1 | **V2-G3** | Pure desk work, newly unblocked, and it is where three separate decisions have already been routed (the hotel archetype gap, the office band-applicability finding, the retail rule change). Writing it now stops those from being re-litigated. |
...
| ⬜ | **V2-G3** | Write the consolidated limitations section | writing | the paper | **UNBLOCKED 08-05** · WP-A ✅ WP-B ✅ C6 ✅ D4 ✅ · three decisions already routed here (hotel archetype gap, office band applicability, retail rule) |
