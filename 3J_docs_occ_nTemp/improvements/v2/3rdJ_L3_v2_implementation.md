...
| **V2-B2** | Re-derive the **hotel** as-modelled band from an archetype-matched reference | 2 h | G-2, decision #2/#3 | **PARTIAL** · contradiction proven, band blocked on V2-F4 |
...
| **V2-F4** | Open CanmetENERGY 2020 archetype study + PNNL-28543 (hotel band) | 2 h | unblocks V2-B2 | **PARTIAL** · hotel ceiling vindicated (302.2); primaries still open |
