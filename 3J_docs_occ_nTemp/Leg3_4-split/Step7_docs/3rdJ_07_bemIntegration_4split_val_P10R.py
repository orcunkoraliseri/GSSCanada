"""P10R SIBLING (2026-09-22) of 3rdJ_07_bemIntegration_4split_val.py (80e4aabd, untouched): reads outputs_step7_P10R/ and _C_v3 only.
...
OUT_DIR = HERE / "outputs_step7_P10R"   # [P10R] sibling products
...
GENERATOR_PY = HERE / "3rdJ_07_aug_to_bem_4split_P10R.py"   # [P10R]
