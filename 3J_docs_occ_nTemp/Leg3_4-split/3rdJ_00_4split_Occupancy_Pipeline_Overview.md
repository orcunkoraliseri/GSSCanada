...
6. Hotel amenity-zone modulation — RESOLVED 2026-07-02 (user-confirmed): v1 = NECB baseline; revisit only if the Step-8 hotel EUI gate (as-modelled 180–300) fails.
