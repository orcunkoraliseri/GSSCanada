...
6. Hotel amenity-zone modulation — RESOLVED 2026-07-02 (user-confirmed): v1 = NECB baseline; revisit only if the Step-8 hotel EUI gate (as-modelled 180–300) fails. ⚠️ **It did fail** (~~21/56~~ **28/56** over the ceiling as of 2026-08-05; count corrected 2026-08-06 by V4-A4) — but the failures are `Tall`-only and the resize work (V2-B4/D10) targets the DHW plant, not amenity modulation; revisiting amenity zones is **not** currently on the task list.
