...
|---|---|---|---|---|
| **Peak-normalize GSS curve per cycle (shape-only; amplitude stays code)** | **Yes — dominant approach in TUS-to-BEM literature.** ~~Richardson et al. (2010) establish the canonical shape-extraction / amplitude-anchoring method: population Markov-chain extracts *shape* from TUS; design occupancy provides *amplitude*.~~ → 🔴 **CORRECTED 2026-08-04 (V2-C8):** on inspection (V2-F1), Richardson, Thomson & Infield (2008, *Energy and Buildings* 40(8), 1560–1566) and the 2010 follow-on (Richardson, Thomson, Infield & Clifford, *Energy and Buildings* 42(10), 1878–1887) instead establish a **household-level first-order Markov chain over the active-occupant count S(t) ∈ {0…N}** at ten-minute resolution with weekday/weekend calibration — not a shape-extraction/amplitude-anchoring (any-present×N-style) model; full text paywalled, correction rests on abstracts + methods, not a page reference. Reinforced by IEA Annex 66 (Haldi et al. 2017) and Reinhart & Cerezo Davila (2016) for commercial UBEM, which remain the load-bearing citations for the shape/amplitude method itself — the verdict in this row is unaffected. Formula: `multiplier(t) = NECB_peak × [at_retail_fraction(t) / max_t(at_retail_fraction(t))]` applied per-cycle. | (1) Preserves code-compliant amplitude — HVAC not undersized vs. NECB design basis. (2) Shape fully reflects GSS-derived temporal pattern including diurnal shift and weekend peak. (3) Computationally trivial: one scalar per cycle per day-type. (4) Valid EnergyPlus multiplier range [0, 1]. | (1) **Severs the longitudinal level signal**: if GSS shows 2005→2022 retail presence declining (2.3%→2.1% all-day), that amplitude decline is discarded — peak always maps to NECB_peak. (2) Requires explicit documentation that amplitude is code-anchored, not empirically derived. | **RECOMMENDED** (see Part C for formula and longitudinal treatment) |
...
**Strongest citation:** ~~Richardson, I., Thomson, M., Infield, D., & Clifford, C. (2010). *Domestic electricity use: A high-resolution energy demand model*. Energy and Buildings, 42(10), 1878–1887. DOI: 10.1016/j.enbuild.2010.05.023 — establishes the canonical shape-extraction / amplitude-anchoring method for TUS-derived occupancy schedules.~~ → 🔴 **CORRECTED 2026-08-04 (V2-C8):** Richardson, Thomson & Infield (2008, *Energy and Buildings* 40(8), 1560–1566), and the 2010 follow-on (Richardson, Thomson, Infield & Clifford, *Energy and Buildings* 42(10), 1878–1887, DOI: 10.1016/j.enbuild.2010.05.023) instead establish a **household-level first-order Markov chain over the active-occupant count S(t) ∈ {0…N}** at ten-minute resolution with separate weekday/weekend calibration — not the shape-extraction/amplitude-anchoring (any-present×N-style) method attributed to them here. Full text is paywalled; this correction rests on the abstracts and methods descriptions, not a page reference. The RECOMMENDED peak-normalization verdict above is unaffected — only this attribution changes. Reinforced for commercial buildings by IEA Annex 66 (Haldi et al. 2017) and Reinhart & Cerezo Davila (2016), which remain the load-bearing citations for the method.
...
16. Richardson, I., Thomson, M., Infield, D., & Clifford, C. (2010). Domestic electricity use: A high-resolution energy demand model. *Energy and Buildings*, 42(10), 1878–1887. DOI: 10.1016/j.enbuild.2010.05.023. [~~Canonical TUS shape-extraction + amplitude-anchoring methodology.~~ → 🔴 **CORRECTED 2026-08-04 (V2-C8):** household-level first-order Markov chain over the active-occupant count S(t) ∈ {0…N} at ten-minute resolution, weekday/weekend-calibrated — not a shape-extraction/amplitude-anchoring method. Paywalled; correction rests on the abstract and methods description, not a page reference.]
16a. Richardson, I., Thomson, M., & Infield, D. (2008). A high-resolution domestic building occupancy model for energy demand simulations. *Energy and Buildings*, 40(8), 1560–1566. [Companion/earlier paper to entry 16, added 2026-08-04 (V2-C8) — same household-level Markov-chain-over-active-occupant-count method; DOI not independently verified this session, full text paywalled.]
