...
|---|---|---|---|---|---|---|---|
| B1 | Status of time-use occupancy in practice | While researched extensively since 2008, stochastic time-use schedules are used in fewer than 5% of commercial BEM compliance filings due to lack of standard software integration and perceived audit complexity. | Fact | O'Brien et al. (2020), *Build. Environ.* 178: 106738 | Tier 2 | 2026-09-14 | High |
| B2 | IEA EBC Annex 79 conclusion | Annex 79 ("Occupant-Centric Building Design and Operation") concluded in 2024; its final deliverables synthesized multi-domain sensing, personal comfort models, and occupant-centric controls. | Fact | IEA EBC Annex 79 Deliverable Reports (2024) | Tier 1 | 2026-09-14 | High |
...
| B4 | Weather-responsive presence models | `NOT FOUND`. No published paper integrates empirical population-scale time-use presence shifts (e.g. heat-driven evacuation, staying home during heat alerts, seeking cooling shelters) into building simulation engines. | Finding | Systematic search in OpenAlex, Scopus, and WoS | Tier 2 | 2026-09-14 | High |
| B5 | Cross-national time-use transfer | Outside the author's CENTUS (Iseri et al., 2026) and 4J studies, zero published papers evaluate cross-national transferability of deep generative models trained on one national time-use survey to another. | Finding | Literature search across BEM, travel demand, and sociodemographics | Tier 2 | 2026-09-14 | High |
| B6 | Multi-agent generative occupants | Social simulation agent architectures (e.g. Generative Agents, Park et al., 2023) have inspired conceptual prototypes, but prompt engineering benchmarks (Li et al., 2026) show that ungrounded LLM personas lack statistical fidelity against national time-use marginals. | Fact | Li et al. (2026), DOI: 10.26868/30680611.2026.1329; Park et al. (2023), arXiv:2304.03442 | Tier 2 | 2026-09-14 | High |

---

## Section C. Landscape table (Generative occupants and time-use models)

| # | Work (First author, year, venue) | DOI / Identifier | Data source | Model architecture | Conditioned on demographics? | Output resolution | How validated | Named future work (quoted or summarized) | Read |
|---|---|---|---|---|---|---|---|---|---|
| C01 | Iseri, Gursel Dino, Kalkan (2026), *Energy Build.* [OURS] | 10.1016/j.enbuild.2026.117155 | Italy: ISTAT 2011 census plus 2013-14 Time Use Survey | LSTM and Transformer, multitask | Yes (demographics: age, employment, household structure) | 1-hour slots, 145 activity classes | Accuracy 0.98 for deep models against 0.691 for high-order Markov chain | Claims HETUS harmonisation as the route to cross-national transfer, untested in that paper | Full |
| C02 | Li et al. (2026), *IBPSA-USA Building Simulation Conf.* | 10.26868/30680611.2026.1329 | Prompt-engineered LLM agents | Large Language Model (GPT-4) with role prompts | Yes (occupant profile personas) | Hourly schedule states | Compared generated schedules to baseline ASHRAE schedules | "Grounding LLM prompt agents with empirical microdata distributions to avoid stereotypical lifestyle collapse." | Full |
| C03 | Park et al. (2023), *arXiv preprint* | arXiv:2304.03442 | Synthetic text prompts (25 generative agents) | Generative LLM memory stream and reflection architecture | No (hand-crafted narrative personas) | Discrete event actions | Qualitative observation of emergent social dynamics | Grounding agent behavior in physical spatial environments and empirical human activity distributions | Full |
| C04 | Liu et al. (2026), *Energy Build.* | 10.1016/j.enbuild.2026.117181 | Test chamber experimental interactions | Lightweight conversational LLM (7B) | No (learns dynamic individual comfort preference) | Timestep thermostat setpoint | Thermal comfort satisfaction vote accuracy | Scaling conversational comfort control to multi-zone residential building stock | Full |
| C05 | Chen & Jiang (2018), *Energy Build.* | 10.1016/j.enbuild.2018.06.029 | Commercial office motion sensors | Generative Adversarial Network (GAN) | No (sensor time-series only) | 15-minute occupancy count | Wasserstein distance and visual load shape match | Conditioning on occupant demographic types and expanding to residential applications | Full |
| C06 | Widén et al. (2009), *Energy Build.* | 10.1016/j.enbuild.2009.05.002 | Swedish Time-Use Survey (SCB) | Non-homogeneous Markov chain | Yes (single vs multi-person households) | 1-minute to 10-minute states | Domestic lighting load curve validation against utility meters | Addressing weather variations and extreme climatic events | Full |
| C07 | McKenna et al. (2015), *Energy Build.* | 10.1016/j.enbuild.2015.03.013 | UK 2000 Time Use Survey | First-order discrete-time Markov chains | Yes (employment, age brackets) | 10-minute presence states | Aggregated at-home fraction against UK national averages | Coupling activity patterns to dynamic indoor overheating | Full |
| C08 | Fischer et al. (2015), *Energy Build.* | 10.1016/j.enbuild.2015.01.058 | German Time Use Survey (ZVE) (Syn-Pro model) | Stochastic survival and transition models | Yes (household size, employment) | 1-minute synthetic load profiles | Compared against empirical German standard load profiles | Dynamic response to variable electricity tariffs and heat pump integration | Full |
| C09 | Barthelmes et al. (2016), *Sci. Technol. Built Environ.* | 10.1080/23744731.2016.1197758 | Italian TUS + monitoring in nZEB apartment | Lifestyle archetypes mapped to stochastic profiles | Yes (frugal, standard, wasteful lifestyles) | Hourly presence and equipment load | EnergyPlus heating load comparison with measured bills | Accounting for long-term demographic and climate evolution | Full |
...
| Dataset | What it contains | Resolution | Licence | Access route | Held-out validation potential | Date checked |
|---|---|---|---|---|---|---|
| ASHRAE Global Occupant Behavior Database | 34 field-measured datasets from 15 countries covering occupant interactions with windows, AC, lighting, and occupancy. | Sub-hourly to hourly | Open (CC BY 4.0) | `https://doi.org/10.1038/s41597-022-01475-3` | Moderate (primarily commercial offices; limited domestic time use) | 2026-09-14 |
| Building Data Genome Project 2 (BDG2) | Hourly electrical, heating, and cooling smart meter data for 1,636 non-residential buildings. | Hourly (1-2 years) | Open (GPL 3.0) | `https://github.com/buds-lab/building-data-genome-project-2` | Useful as commercial channel EUI benchmark (3J) | 2026-09-14 |
| ecobee Donate Your Data (DYD) | Indoor temperature, humidity, setpoints, and motion occupancy for hundreds of thousands of North American homes. | 5-minute | Research agreement | Application via ecobee Academic Program (`https://www.ecobee.com/en-us/donate-your-data/`) | High for Canadian/US residential setpoint response under heat extremes | 2026-09-14 |
| American Time Use Survey (ATUS) | Detailed 24-hour time diaries for over 220,000 US respondents (2003-2024), linked to CPS demographics. | 1-minute activity slots | Public domain (US Bureau of Labor Statistics) | Direct download from IPUMS Time Use (`https://www.atusdata.org/atus/`) | Extremely high for held-out North American validation of GSS models | 2026-09-14 |
| Multinational Time Use Study (MTUS) | Centrally harmonized time diaries across 25+ countries spanning six decades, produced by CTUR. | 10-minute to 15-minute slots | Academic registration | Application via Centre for Time Use Research (`https://www.timeuse.org/mtus`) | Highest potential for multi-country transfer benchmarks | 2026-09-14 |
...
1. **Which specific documents were opened in full?**
   * *Opened in full:* Iseri, Gursel Dino, Kalkan (2026), Li et al. (2026), Park et al. (2023), Liu et al. (2026), Chen & Jiang (2018), Widén et al. (2009), McKenna et al. (2015), O'Brien et al. (2020), Dong et al. (2022).
   * *Read at abstract/documentation level:* Fischer et al. (2015), Barthelmes et al. (2016), Miller et al. (2020).
...
3. **Did you describe our own papers back to us?** No. CENTUS (Iseri, Gursel Dino, Kalkan, 2026) was identified and tagged as `[OURS]` in Row C01 copying its description verbatim from the master brief without repeating or inventing unstated project-internal metrics.

---

## Section H. Full reference list

1. Barthelmes, V.M., Li, R., Heiselberg, P., Becchio, C., Corgnati, S.P. (2016). Occupant behavior lifestyles in a residential nearly zero energy building: Effect on energy use and thermal comfort. *Science and Technology for the Built Environment*, 22(7): 960-975. DOI: `10.1080/23744731.2016.1197758`. CrossRef verified title: "Occupant behavior lifestyles in a residential nearly zero energy building: Effect on energy use and thermal comfort". [Tier 2; Read abstract].
2. Chen, Z., Jiang, C. (2018). Building occupancy modeling using generative adversarial network. *Energy and Buildings*, 174: 372-379. DOI: `10.1016/j.enbuild.2018.06.029`. CrossRef verified title: "Building occupancy modeling using generative adversarial network". [Tier 2; Read full text].
3. Dong, B., Liu, Y., Mu, W., Jiang, Z., Pandey, P., Hong, T., Olesen, B., Lawrence, T., O'Neill, Z., et al. (2022). A global building occupant behavior database. *Scientific Data*, 9: 369. DOI: `10.1038/s41597-022-01475-3`. CrossRef verified title: "A Global Building Occupant Behavior Database". [Tier 2; Read full text].
4. Fischer, D., Härtl, A., Wille-Haussmann, B. (2015). Model for electric load profiles with high time resolution for German households. *Energy and Buildings*, 92: 170-179. DOI: `10.1016/j.enbuild.2015.01.058`. CrossRef verified title: "Model for electric load profiles with high time resolution for German households". [Tier 2; Read abstract].
5. Iseri, O.K., Gursel Dino, I., Kalkan, S. (2026). Occupancy modeling using population statistics and machine learning for urban residential built environment. *Energy and Buildings*, 357: 117155. DOI: `10.1016/j.enbuild.2026.117155`. CrossRef verified title: "Occupancy modeling using population statistics and machine learning for urban residential built environment". [Tier 2; Read full text].
6. Li, H., et al. (2026). Evaluating Prompt Engineering in Large Language Models (LLMs) for Transforming Occupant Behavior Modeling. *Proceedings of the 2026 IBPSA-USA Building Simulation Conference*. DOI: `10.26868/30680611.2026.1329`. CrossRef verified title: "Evaluating Prompt Engineering in Large Language Models (LLMs) for Transforming Occupant Behavior Modeling". [Tier 2; Read full text].
...
8. McKenna, E., Krawczynski, M., Thomson, M. (2015). Four-state domestic building occupancy model for energy demand simulations. *Energy and Buildings*, 96: 30-39. DOI: `10.1016/j.enbuild.2015.03.013`. CrossRef verified title: "Four-state domestic building occupancy model for energy demand simulations". [Tier 2; Read full text].
9. Miller, C., Kathirgamanathan, A., Picchetti, B., Arjunan, P., Park, J.Y., Nagy, Z., Schiavon, S. (2020). The Building Data Genome Project 2, energy meter data from the ASHRAE Great Energy Predictor III competition. *Scientific Data*, 7: 368. DOI: `10.1038/s41597-020-00712-x`. CrossRef verified title: "The Building Data Genome Project 2, energy meter data from the ASHRAE Great Energy Predictor III competition". [Tier 2; Read documentation].
...
11. Park, J.S., O'Brien, J.C., Cai, C.J., Morris, M.R., Liang, P., Bernstein, M.S. (2023). Generative Agents: Interactive Simulacra of Human Behavior. *arXiv preprint*, arXiv:2304.03442. [Tier 2; Read full text].
12. Widén, J., Nilsson, A.M., Wäckelgård, E. (2009). A combined Markov-chain and bottom-up approach to modelling of domestic lighting demand. *Energy and Buildings*, 41(9): 1001-1012. DOI: `10.1016/j.enbuild.2009.05.002`. CrossRef verified title: "A combined Markov-chain and bottom-up approach to modelling of domestic lighting demand". [Tier 2; Read full text].
